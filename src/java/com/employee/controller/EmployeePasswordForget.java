...
@WebServlet(name = "EmployeePasswordForget", urlPatterns = {"/EmployeePasswordForget"})
public class EmployeePasswordForget extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
             ...
             try
               {
                 ...
                 ResultSet rs=st.executeQuery("Select * from EmployeeCredential where email='"+email+"'");
                 rs.next();
        ...
        else if("back".equals(action))
        {
         ...
         response.sendRedirect("EmployeeOtp.jsp");
