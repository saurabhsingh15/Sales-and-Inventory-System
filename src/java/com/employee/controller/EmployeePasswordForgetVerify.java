...
@WebServlet(name = "EmployeePasswordForgetVerify", urlPatterns = {"/EmployeePasswordForgetVerify"})
public class EmployeePasswordForgetVerify extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
       ...
       System.out.println("OTP IS PASSED BY MAIL : "+otp+" , OTP PASSED BY USER : "+request.getParameter("otptext"));
        ...
        {
            response.sendRedirect("EmployeePasswordForget2.html");
        }
