...
@WebServlet(name = "AuthorityPasswordForget", urlPatterns = {"/AuthorityPasswordForget"})
public class AuthorityPasswordForget extends HttpServlet {
             ...
             try
               {
                 ...
                 ResultSet rs=st.executeQuery("Select * from AuthorityCredential where authority_Id=1 and email='"+email+"'");
                 rs.next();
