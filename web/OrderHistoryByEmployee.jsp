...
-->      
       ...
       <%
           ...
           ResultSet rs1=st.executeQuery("select order_Id from placedorder where employee_Id="+employeeId+" order By order_Id desc");
           while(rs1.next())
           {
...
<div id="rectanglecyan"> 
    <div id="attendence"> ORDERS BY EMPLOYEE </div>
</div>
