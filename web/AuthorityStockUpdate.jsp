...
<head>
  ...
  <link rel="stylesheet" href="AuthorityStockUpdate.css">
  <style>
...
<div class="col-sm-10">
 ...
 <!--CONNECTION WITH DATABASE-->
    ...
    <div class="col-md-3"> 
      <form action="AUpdateStock" method="post">
       <div class="card">
        ...
        <input type="text" value="<%=rs.getInt(6)%>" name="stock">
        </div>
        <p><button>UPDATE STOCK</button></p>
       </div>
      </div>   
     </form> 
  <% } %>  
